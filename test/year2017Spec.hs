...
spec = parallel $ do
    describe "Day 01" $ do
        input <- getDay 01
        test "part 1" D01.solveA input $ 1251
        test "part 2" D01.solveB input $ 1244
    describe "Day 02" $ do
        input <- getDay 02
        test "part 1" D02.solveA input $ 43074
        test "part 2" D02.solveB input $ 280
    describe "Day 03" $ do
        input <- getDay 03
        test "part 1" D03.solveA input $ 371
        test "part 2" D03.solveB input $ 369601
    describe "Day 04" $ do
        input <- getDay 04
        test "part 1" D04.solveA input $ 383
        test "part 2" D04.solveB input $ 265
    describe "Day 05" $ do
        input <- getDay 05
    ...
    describe "Day 07" $ do
        ...
        test "part 2" D07.solveB input $ Just 749
    describe "Day 08" $ do
        input <- getDay 08
        test "part 1" D08.solveA input $ 5849
        test "part 2" D08.solveB input $ 6702
    describe "Day 09" $ do
        input <- getDay 09
        test "part 1" D09.solveA input $ 12396
        test "part 2" D09.solveB input $ 6346
    describe "Day 10" $ do
        input <- getDay 10
        test "part 1" D10.solveA input $ 1935
        test "part 2" D10.solveB input $ "dc7e7dee710d4c7201ce42713e6b8359"
    describe "Day 11" $ do
        input <- getDay 11
        test "part 1" D11.solveA input $ 687
        test "part 2" D11.solveB input $ 1483
    describe "Day 12" $ do
        input <- getDay 12
        test "part 1" D12.solveA input $ 239
        test "part 2" D12.solveB input $ 215
    describe "Day 13" $ do
        input <- getDay 13
        test "part 1" D13.solveA input $ 1840
    ...
    describe "Day 16" $ do
        input <- getDay 16
        test "part 1" D16.solveA input $ "giadhmkpcnbfjelo"
        test "part 2" D16.solveB input $ "njfgilbkcoemhpad"
    describe "Day 17" $ do
        input <- getDay 17
        test "part 1" D17.solveA input $ 1561
        test "part 2" D17.solveB input $ 33454823
    describe "Day 18" $ do
        input <- getDay 18
        test "part 1" D18.solveA input $ 3188
        test "part 2" D18.solveB input $ 7112
    describe "Day 19" $ do
        input <- getDay 19
        test "part 1" D19.solveA input $ "SXWAIBUZY"
        test "part 2" D19.solveB input $ 16676
    describe "Day 20" $ do
        input <- getDay 20
